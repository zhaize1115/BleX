...
//			}
			...
			mUpdateDialog.setTitle(R.string.ota_update_cancel);
			mUpdateDialog.setMessage(mContext.getString(R.string.ota_updating));
				...
				switch (msg.what) {
					...
					case BleOtaUpdater.OTA_FAIL:
						if (otaManager.mUpdateDialog != null) {
							...
							builder.setMessage(otaManager.mContext.getResources().getString(R.string.ota_update_error, bleDevice != null ? "[" + bleDevice.getBleName() + "]" : ""));
							final BleOtaUpdater otaUpdater = updater;
							builder.setPositiveButton(R.string.ota_update_retry, new DialogInterface.OnClickListener() {
								@Override
								public void onClick(DialogInterface dialog, int which) {
									dialog.dismiss();
							...
							builder.setNegativeButton(R.string.ota_update_cancel, new DialogInterface.OnClickListener() {
								@Override
								public void onClick(DialogInterface dialog, int which) {
									dialog.dismiss();
								}
